...
module.exports = (provider) => {
  router.get('/interaction/:grantId', async (req, res) => {
    ...
    return res.redirect(`/web${view}/${req.params.grantId}?client_id=${details.params.client_id}&scope=${encodeURIComponent(details.params.scope)}&returnTo=${encodeURI(details.returnTo)}`);
  });
